...
namespace PROYECTONINJA
{
    public partial class mapa3 : Form
    {
        ...
        private void mapa3_Load(object sender, EventArgs e)
        {
            generar();

            int x3 = 250;
            int y3 = 250;
            h = new plataformas("pl_desierto", x3, y3, 100, 100);
            ...
            int x5 = 650;
            int y5 = 250;
            i = new plataformas("pl_desierto", x5, y5, 100, 100);
        ...
        public void generar() 
        {
            ...
            {
                plataformas plataform = new plataformas("suelo nieve", posiciones[i, 0], posiciones[i, 1], 100, 100);
                p.Add(plataform);
